...
function ChatArea() {
  return (
    <div className="relative flex h-screen flex-1 flex-col overflow-hidden">
      <ChatContainerRoot className="h-full overflow-y-auto px-1 pb-20 md:px-4 hide-scrollbar">
        <ChatContainerContent className="space-y-12 px-1 pb-20 md:px-4">
              ...
              >
                ...
                >
                  ...
                  <div
                    className={cn(
                      "group flex flex-col",
                      isAssistant ? "gap-0" : "items-end gap-1",
                    )}
                  >
                    {isAssistant ? (
                      <MessageContent
                        className="prose text-foreground w-full max-w-[85%] flex-1 overflow-x-auto rounded-lg bg-transparent p-0 py-0 sm:max-w-[75%]"
                        markdown
                      >
                        {message.content}
                      </MessageContent>
        ...
        <div className="absolute right-7 bottom-4 z-10">
          <ScrollButton variant="default" size="icon" />
        </div>
      </ChatContainerRoot>
    </div>
  );
